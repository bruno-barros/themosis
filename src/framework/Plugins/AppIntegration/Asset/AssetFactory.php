...
class AssetFactory {
    ...
    public function add($handle, $path, $deps = array(), $version = '1.0', $mixed = null)
    {
	    ...
	    $appIntegration = AppIntegration::getInstance();

        // No extension, isolated case. Return WP_Error object for info.
        return new \WP_Error('asset', __('No file extension found. Perhaps paste your asset code in your &lt;head&gt; tag.', $appIntegration->get_plugin_name()));
    }
